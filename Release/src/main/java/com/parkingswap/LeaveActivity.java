...
public class LeaveActivity extends AppCompatActivity
    ...
    public static ArrayList<LatLng> setDirection = new ArrayList<>();
    public static LatLng current;
    public static LatLng destination;
    public static Dialog alert;
    public static AlertDialog Info_Leave;
    public static Context Leave_Context;

    public void ClientExecute(boolean check){
        if (check==false) {
            ServerLeave client = new ServerLeave();
            client.execute();
        }
    }
    public static void openInfo_Leave(Context context){
        Info_Leave = new AlertDialog.Builder(context)
                .setTitle("Matched User Car Information")
                .setMessage("Model: "+ServerPark.Model_Park+"\n"+"Make: "+ServerPark.Make_Park+"\n"+"Color: "+ServerPark.Color_Park)
                .show();
    ...
    public void openDialog() {
        alert = new AlertDialog.Builder(this)
                ...
                .setMessage("Please wait while we find you a match.")
                .setIcon(R.drawable.sand)
                .show();
    }
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            if (lastLocation != null){
                ...
                ClientExecute(LotActivity.done);
            }
        }
    ...
    public void onBackPressed() {
        LotActivity.done = false;
        this.startActivity(new Intent("Lot_class.Lot"));
    }
